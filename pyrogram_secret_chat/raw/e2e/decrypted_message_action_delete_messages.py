...
class DecryptedMessageActionDeleteMessages(TLObject):  # type: ignore
    """Telegram API method.
    ...
    ID = 0x65614304
    QUALNAME = "e2e.DecryptedMessageActionDeleteMessages"

    def __init__(self, *, random_ids: List[int]) -> None:
        self.random_ids = random_ids  # Vector<long>

    @staticmethod
    def read(b: BytesIO, *args: Any) -> "DecryptedMessageActionDeleteMessages":
        # No flags
