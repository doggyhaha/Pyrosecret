...
class DecryptedMessageMediaVideo(TLObject):  # type: ignore
    """Telegram API method.
    ...
    __slots__: List[str] = ["thumb", "thumb_w", "thumb_h", "duration", "mime_type", "w", "h", "size", "key", "iv", "caption"]

    ID = 0x970c8c0e
    QUALNAME = "e2e.DecryptedMessageMediaVideo"
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "DecryptedMessageMediaVideo":
        # No flags
        ...
        return DecryptedMessageMediaVideo(thumb=thumb, thumb_w=thumb_w, thumb_h=thumb_h, duration=duration, mime_type=mime_type, w=w, h=h, size=size, key=key, iv=iv, caption=caption)
