...
class DecryptedMessageActionCommitKey(TLObject):  # type: ignore
    """Telegram API method.
    ...
    __slots__: List[str] = ["exchange_id", "key_fingerprint"]

    ID = 0xec2e0b9b
    QUALNAME = "e2e.DecryptedMessageActionCommitKey"
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "DecryptedMessageActionCommitKey":
        # No flags
