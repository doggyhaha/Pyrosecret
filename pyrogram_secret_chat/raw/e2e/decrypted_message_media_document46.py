...
class DecryptedMessageMediaDocument46(TLObject):  # type: ignore
    """Telegram API method.
    ...
    ID = 0x7afe8ae2
    QUALNAME = "e2e.DecryptedMessageMediaDocument46"
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "DecryptedMessageMediaDocument46":
        # No flags
        ...
        return DecryptedMessageMediaDocument46(thumb=thumb, thumb_w=thumb_w, thumb_h=thumb_h, mime_type=mime_type, size=size, key=key, iv=iv, attributes=attributes, caption=caption)
