...
class DecryptedMessageActionAbortKey(TLObject):  # type: ignore
    """Telegram API method.
    ...
    __slots__: List[str] = ["exchange_id"]

    ID = 0xdd05ec6b
    QUALNAME = "e2e.DecryptedMessageActionAbortKey"

    def __init__(self, *, exchange_id: int) -> None:
        self.exchange_id = exchange_id  # long

    @staticmethod
    def read(b: BytesIO, *args: Any) -> "DecryptedMessageActionAbortKey":
        # No flags
