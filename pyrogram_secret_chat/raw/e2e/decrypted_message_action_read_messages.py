...
class DecryptedMessageActionReadMessages(TLObject):  # type: ignore
    """Telegram API method.
    ...
    ID = 0xc4f40be
    QUALNAME = "e2e.DecryptedMessageActionReadMessages"

    def __init__(self, *, random_ids: List[int]) -> None:
        self.random_ids = random_ids  # Vector<long>

    @staticmethod
    def read(b: BytesIO, *args: Any) -> "DecryptedMessageActionReadMessages":
        # No flags
