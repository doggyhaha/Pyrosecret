...
class DecryptedMessageMediaDocument8(TLObject):  # type: ignore
    """Telegram API method.
    ...
    __slots__: List[str] = ["thumb", "thumb_w", "thumb_h", "file_name", "mime_type", "size", "key", "iv"]

    ID = 0xb095434b
    QUALNAME = "e2e.DecryptedMessageMediaDocument8"
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "DecryptedMessageMediaDocument8":
        # No flags
        ...
        return DecryptedMessageMediaDocument8(thumb=thumb, thumb_w=thumb_w, thumb_h=thumb_h, file_name=file_name, mime_type=mime_type, size=size, key=key, iv=iv)
