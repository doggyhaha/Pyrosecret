...
class DecryptedMessageMediaPhoto(TLObject):  # type: ignore
    """Telegram API method.
    ...
    __slots__: List[str] = ["thumb", "thumb_w", "thumb_h", "w", "h", "size", "key", "iv", "caption"]

    ID = 0xf1fa8d78
    QUALNAME = "e2e.DecryptedMessageMediaPhoto"
    ...
    @staticmethod
    def read(b: BytesIO, *args: Any) -> "DecryptedMessageMediaPhoto":
        # No flags
        ...
        return DecryptedMessageMediaPhoto(thumb=thumb, thumb_w=thumb_w, thumb_h=thumb_h, w=w, h=h, size=size, key=key, iv=iv, caption=caption)
